...
const Agua = ({ porcentagemAgua }) => {
    const [porcentagem, setPorcentagem] = useState(porcentagemAgua);
    ...
    return (
      <View style={styles.container}>
        ...
        <Image source={require("C:/Users/igor5/Documents/FACUL/LIEC/Trabalho/comedouroAnimais/assets/cachorro.png")} style={styles.cachorro} />
        <Botao title={"Adicionar mais ração"} handle={() => handleAlimenta({ alimento: "agua", porcentagem })}></Botao>
